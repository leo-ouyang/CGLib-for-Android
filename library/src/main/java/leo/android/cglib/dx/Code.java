...
import static leo.android.cglib.dx.rop.code.Rop.BRANCH_GOTO;
import static leo.android.cglib.dx.rop.code.Rop.BRANCH_NONE;
import static leo.android.cglib.dx.rop.code.Rop.BRANCH_RETURN;
import static leo.android.cglib.dx.rop.type.Type.BT_BYTE;
import static leo.android.cglib.dx.rop.type.Type.BT_CHAR;
import static leo.android.cglib.dx.rop.type.Type.BT_INT;
import static leo.android.cglib.dx.rop.type.Type.BT_SHORT;
...
import leo.android.cglib.dx.rop.code.BasicBlockList;
import leo.android.cglib.dx.rop.code.Insn;
import leo.android.cglib.dx.rop.code.PlainCstInsn;
import leo.android.cglib.dx.rop.code.PlainInsn;
...
import leo.android.cglib.dx.rop.code.ThrowingCstInsn;
import leo.android.cglib.dx.rop.code.ThrowingInsn;
import leo.android.cglib.dx.rop.cst.CstInteger;
...
public final class Code {
   ...
   public <D, V> void iput(FieldId<D, V> fieldId, Local<D> instance, Local<V> source) {
    ...
    private Rop getCastRop(leo.android.cglib.dx.rop.type.Type sourceType,
            leo.android.cglib.dx.rop.type.Type targetType) {
