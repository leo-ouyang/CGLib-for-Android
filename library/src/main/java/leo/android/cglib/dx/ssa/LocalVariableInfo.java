...
import leo.android.cglib.dx.util.MutabilityControl;

/**
 * Container for local variable information for a particular {@link
 * leo.android.cglib.dx.ssa.SsaMethod}.
 * Stolen from {@link leo.android.cglib.dx.rop.code.LocalVariableInfo}.
 */
public class LocalVariableInfo         extends MutabilityControl {
    ...
    /**
     * {@code non-null;} {@link leo.android.cglib.dx.rop.code.RegisterSpecSet} to use when indicating a block
     ...
     * {@link leo.android.cglib.dx.rop.type.TypeBearer} (such as a constant value).
     *
